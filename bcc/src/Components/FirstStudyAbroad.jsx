...
<div className="h-screen w-screen">
    ...
    <div className="border-2 border-purple-300 rounded-[20px] w-[400px] h-[150px] p-[32px] pl-[100px] ">
        <h1 className="text-[24px] font-bold -mt-[10px]">Persiapan Esai</h1>
    ...
    <div className="absolute pt-[350px] pl-[1000px]">
        ...
        <div className="pt-[32px]">
    <div className="border-2 border-purple-300 rounded-[20px] w-[400px] h-[150px] p-[32px] pl-[100px] ">
        <h1 className="text-[24px] font-bold -mt-[10px]">Persiapan Wawancara</h1>
    ...
    <div className="absolute pt-[550px] pl-[1000px]">
        ...
        <div className="pt-[32px]">
    <div className="border-2 border-purple-300 rounded-[20px] w-[400px] h-[150px] p-[32px] pl-[100px] ">
        <h1 className="text-[24px] font-bold -mt-[10px]">Persiapan TOEFL</h1>
