    ...
    <>
      ...
      <dialog id="my_modal_1" className="modal">
        <div className="modal-box bg-purple-100 h-[437px] w-[400px] p-[32px]">
          ...
          <h3 className="font-bold text-[24px] text-center -mt-[50px] text-purple-300">
            Enjoying Schofinity?
          </h3>
          ...
          <div className="">
            <input
              ...
              className=" pb-[100px] input w-full rounded-[0px] bg-gray-300 max-w-xs mt-[20px] h-[150px] "
            />
          </div>
          ...
          <div className="flex space-x-[200px]">
            <div className="pt-[30px] ">
              <form method="dialog">
                <button className="btn bg-white border-purple-100 text-purple-300">
                  Cancel
                </button>
              </form>
            </div>
            ...
            <div className="pt-[30px]">
              <form method="dialog">
                <button className="btn bg-purple-300 border-purple-100 text-white">
                  Post
                </button>
              </form>
            </div>
