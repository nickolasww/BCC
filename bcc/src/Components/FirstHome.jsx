    ...
    return(
        ...
        <div className="font-Poppins px-38 py-7 ">
            <div className="flex pl-20 space-x-1 text-center ">
                ...
                <Link to="/"><h1 className=" font-bold h-4 mt-3 text-base">Scofinity</h1></Link>
            ...
            <div className=" flex pl-56 space-x-2 cursor-pointer">
                ...
                <Link to="/Login"><h1 className="bg-purple-300 rounded-full px-7 py-2 text-white font-bold">Log in</h1></Link>
            </div>
            </div>
        </div>
