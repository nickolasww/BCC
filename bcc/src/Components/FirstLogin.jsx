      ...
      <div className=" relative flex justify-end items-start w-screen h-screen bg-purple-300  ">
        ...
        <div className=" w-96 pl-60 pr-60 pt-10 pb-30 mr-48 mt-14 mb-32 rounded-3xl bg-white border-2 flex-none absolute">
          ...
          <form className=" -ml-60 -mr-60 -mt-10 pr-10 p-16 justify-center">
            ...
            <div className="">
              <input
                className="input-box text-base px-4 py-1 mb-4 mt-9 w-full rounded-full border-2 border-gray-400 bg-transparent"
                type="text"
            ...
            <div className="">
              <input
                className="input-box text-base px-4 py-1 mb-4 w-full rounded-full border-2 border-gray-400 bg-transparent"
                type="Password"
            ...
            <div className="text-center mt-9">
              <p>
                ...
                <a href=" " className="font-bold text-purple-300">
                  {" "}
                  Sign Up
                </a>
              </p>
