          ...
          <form className="h-[450px] p-[20px] justify-center m-[64px] border-red-900 border-4">
            ...
            <div className="flex">
              <div className=" text-base h-[80px] w-[] text-center rounded-[15px] border-2 border-gray-400 bg-transparent ">
                <input />
                <span
                  className=" text-base h-[80px] w-[60px] text-center rounded-[15px] "
                  type="number"
                  required
                ></span>
              </div>
              ...
              <div className="">
                <input
                  className="input-box text-base h-[80px] w-[40px] p-[32px] justify-items-center rounded-[15px] border-2 border-gray-400 bg-transparent"
                  type="text"
                  required
                />
              </div>
              ...
              <div className="">
                <input
                  className="input-box text-base h-[80px] w-[60px] p-[32px] justify-items-center rounded-[15px] border-2 border-gray-400 bg-transparent"
                  type="text"
                  required
                />
              </div>
            ...
            <div>
              <button
                className=" w-full h-full px-2 py-1 mt-5 mb-4 rounded-full border-2 border-purple-300 bg-purple-300 text-white font-semibold "
                type="submit"
              >
                Next
              </button>
